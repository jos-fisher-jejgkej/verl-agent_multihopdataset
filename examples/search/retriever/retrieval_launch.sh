...
export HF_HOME=/mnt/project/fsh/verl-agent_multihopdataset/.cache
export HF_DATASETS_CACHE=$HF_HOME/datasets_cache
export TRANSFORMERS_CACHE=$HF_HOME/transformers_cache
save_path=/mnt/project/fsh/corpus
index_file=$save_path/e5_Flat.index
corpus_file=$save_path/wiki-18.jsonl
retriever_name=e5
retriever_path=/mnt/project/fsh/verl-agent/_model/e5-base-v2

# # 在运行您的 Python 脚本之前在终端中执行
# export HF_DATASETS_CACHE="/root/autodl-tmp/verl-agent/.cache"
